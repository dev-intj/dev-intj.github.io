...
export const ProjectEntry = ({ project }) => {
    ...
    return <div className="article portfoflio-project">
        <div>
            <div className="portfoflio-project-thumbnail">
                ...
                >
                    ...
                    <a onClick={() => GoToLink(project.site)} className="pf-p-full-size-link"></a>
                    <a
                    ...
                    {project.blog == true ? (
                        ...
                        <a className="pf-p-project-view" onClick={() => GoToLink(project.site)}>
                            View
                            <IconContext.Provider
                                value={{ className: "work-icons", size: 18 }}
                            >
