...
export default {
  ...
  header: {
    ...
    header_footer_subtitle:
      "I'm a UI/UX designer aiming to be a Full Stack Web Developer",
  },
  //Skills Section
  skills: [
    {
      title: "Back-end Developer",
      img: <BackendIcon width="100%" height="100%" />,
    ...
    },
    {
      ...
      img: <FrontendIcon width="100%" height="100%" />,
    ...
    },
    {
      ...
      img: <UiuxdesIcon width="100%" height="100%" />,
      alt: "ui/ux designer",
  ...
  about_header: {
    ...
    subtitle:
      "A Web Developer from Greece. I've been coding & designing for over 4 years.",
    class: "white",
  },
  about1: [
    {
      paragraph:
        "My main experience is in UI/UX but I love Front-End Development and Back-End Development. I have experience managing a project from initial consultation to launch, using analytics to read the behavior of the users and influence them through carefully pixel - perfect design elements.",
      class: "is-primary",
    },
    {
      paragraph:
        "Throughout those 4 years, I’ve worked remotely for a number of clients and established companies. These have been located to mainly english speaking countries, from United Kingdom to United States.",
      class: "is-white",
    },
  ],
  about2: [
    {
      paragraph:
        "I have worked on a multitude of projects with different technologies, on the Web Design (Photoshop, AdobeXD, Illustrator, InDesign) and Development (HTML, SCSS, JS, jQuery, BootStrap, ReactJS) having in mind responsiveness and scalability.",
      class: "is-primary",
    },
  ],
  About_contact: {
    contact_paragraph:
      "I take great pride in having the ability to complete work to the high standard you expect But also go the extra mile. I enjoy getting to know my clients, their ideals and their goals And how I can best apply myself to make sure their website succeeds. I always like Analyzing metrics and making data - based decisions and Recommendations, resulting in higher rates of success.",
