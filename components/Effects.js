...
const ShaderPass = dynamic(() => import('three/examples/jsm/postprocessing/ShaderPass'))
const SavePass = dynamic(() => import('three/examples/jsm/postprocessing/SavePass'))
const CopyShader = dynamic(() => import('three/examples/jsm/shaders/CopyShader'))
const FXAAShader = dynamic(() => import('three/examples/jsm/shaders/FXAAShader'))
